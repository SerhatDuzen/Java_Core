...
public class Scope1 {
    ...
    public boolean izindeMi; // deafult deger false
...
private int x= 9;
    public static void main(String[] args) {
        ...
        // bu javadaki standart obje olusturma formudur
    ...
    public void method() {
        System.out.println(sayi); // b metho static olmadigi icin instance
        //variablelara direk erisebilr
        sayi+=20; // ve bu method icersinde gecerli olmak uzere degistirebilir
